 ...
 */
export type BrowseState = { sort: string; category?: string; query?: string };

const SORTS = [
  { key: "recent", label: "최신순" },
  { key: "popular", label: "많이 눌린 순" },
] as const;
    ...
    <div className="mt-4 flex flex-col gap-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <form action="/" method="get" className="ml-auto flex items-center gap-1.5">
          {state.sort !== "recent" && <input type="hidden" name="sort" value={state.sort} />}
