...
it('생존 확인은 maintenance 역할에서 1분마다 돈다', () => {
  ...
  expect(new Set(jobsForRole('maintenance'))).toEqual(new Set(['uptime-ping', 'click-rollup', 'ranking-refresh', 'news-refresh', 'product-thumbnail-refresh', 'product-search-refresh']));
