...
- User ProductHero.tsx and nomorevibe_final artifacts untouched. Do not stage them. No commit/deploy yet. Need finish finalchecks, own diffreview, commit/push, releaseenv+Dokploy6apps(web2/crawler/publisher/reviewer/maintenance), observeactualcompletion, reportremainingpolicy/image/secondreviewlimitations.
