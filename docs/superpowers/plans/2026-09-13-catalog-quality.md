...
- [x] Commit own files, directDB migration, deploy affected services, verify search/nine cards/star states and exclusion pages, preserve user Hero changes. Final operations report, CODEX_HANDOFF and Obsidian journal.
