...
- [ ] Deterministic counts and original URLs; settings excluded from contribution counts, no execution certainty or made-up accuracy.
- [ ] Fixture integration tests and documented invocation/output; no automatic production mutation or public-column restoration.
